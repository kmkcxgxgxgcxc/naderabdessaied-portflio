            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                 Jai travaillé sur une grande variété de projets, allant de simples sites web à des applications web complexes. Voici quelques-uns de mes préférés.
                </p>
              </div>
            </div>
          </BlurFade>
        ...
        <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-12">
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              Nhésitez pas à me contacter au {" "}
                <Link
                  className="text-blue-500"
                  href="https://www.linkedin.com/in/nader-abdessaied-952bb9177/"
                >
                  LinkedIn{" "}
                </Link>
              Si vous souhaitez discuter, je vous répondrai dès que possible ! 🙂
              </p>
            </div>
          </BlurFade>
        </div>
